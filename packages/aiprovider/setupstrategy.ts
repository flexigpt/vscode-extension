...
export function getOpenAIProvider(
  ...
  const timeout = (config.get("openai.timeout") as BigInt) || BigInt(120);
...
export function getAnthropicProvider(
  ...
  const timeout = (config.get("anthropic.timeout") as BigInt) || BigInt(120);
  const defaultCompletionModel =
...
export function getHuggingFaceProvider(
  ...
  const timeout = (config.get("huggingface.timeout") as BigInt) || BigInt(120);
  const defaultCompletionModel =
...
export function getGoogleGenerativeLanguageProvider(
  ...
  const timeout = (config.get("googlegl.timeout") as BigInt) || BigInt(120);
  const defaultCompletionModel =
...
export function getLlamaCPPAPIProvider(
  ...
  const timeout = (config.get("llamacpp.timeout") as BigInt) || BigInt(120);
  // const defaultCompletionModel =
